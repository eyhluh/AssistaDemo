  ...
  const handleDestroyUser = async (e: FormEvent) => {
    try {
      ...
      if (res.status === 200) {
        ...
        console.error(
          "Unexpected status error while deleting user:",
          res.status
        );
      }
    } catch (error) {
      console.error(
        "Unexpected server error occurred while deleting user:",
        error
      );
    } finally {
        ...
        <form onSubmit={handleDestroyUser}>
          ...
          <div className="grid grid-cols-2 gap-4 border-b border-gray-100 mb-4">
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="mb-4">
                <label htmlFor="gender" className="font-medium text-black mb-2">
                  Gender
                </label>
